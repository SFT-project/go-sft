...
func (s *spongeDb) NewBatch() sftdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) sftdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w sftdb.KeyValueWriter) error { return nil }
