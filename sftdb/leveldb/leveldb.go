...
func (db *Database) NewBatch() sftdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) sftdb.Iterator {
...
func (b *batch) Replay(w sftdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  sftdb.KeyValueWriter
	failure error
}
