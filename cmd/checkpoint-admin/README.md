...
```shell
go get github.com/geth-project/go-geth/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/sft/go-sft/blob/master/params/config.go#L251).*
