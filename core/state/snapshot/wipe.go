...
func wipeSnapshot(db sftdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db sftdb.KeyValueStore) error {
...
func wipeKeyRange(db sftdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
