...
type Tree struct {
	diskdb sftdb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb sftdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
