...
func NewTable(db sftdb.Database, prefix string) sftdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) sftdb.Iterator {
...
func (t *table) NewBatch() sftdb.Batch {
...
func (b *tableBatch) Replay(w sftdb.KeyValueWriter) error {
